...
.user {
  background: #d4af37;
  color: #000;
  align-self: flex-end; /* Aquesta és la clau de la posició */
...
.bot {
  background: #333;
  color: #fff;
  align-self: flex-start; /* Aquesta és la clau de la posició */
...
.input-area {
  ...
  display: flex;
  gap: 8px;
  border-top: 1px solid #333; /* Línia molt fina per separar */
}
...
.send-btn {
  ...
  color: #000;
  border: none;
  width: 35px; /* Botó quadrat o rodó petit */
  height: 35px;
  border-radius: 50%; /* Rodó */
  cursor: pointer;
  display: flex;
  align-items: center;
...
.send-btn:hover {
  background: #b8962f; /* Un to daurat una mica més fosc en passar el ratolí */
}
</style>